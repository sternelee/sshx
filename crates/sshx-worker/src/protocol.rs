//! WebSocket protocol definitions for sshx-worker
//!
//! This module defines the WebSocket message types and protocol used for
//! real-time communication between the web frontend and the Cloudflare Worker.
...
impl fmt::Display for ProtocolError {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        match self {
            ...
            ProtocolError::SessionNotFound(msg) => write!(f, "Session not found: {}", msg),
            ProtocolError::ShellNotFound(msg) => write!(f, "Shell not found: {}", msg),
            ProtocolError::UserNotFound(msg) => write!(f, "User not found: {}", msg),
