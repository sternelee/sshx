...
/// Re-export core types used in the protocol.
pub type Sid = u32;
pub type Uid = u32;
...
/// Protocol used by CLI backend over WebSocket.
/// Each message is a protobuf-encoded `ClientUpdate` or `ServerUpdate`.
pub const BACKEND_WS_PROTOCOL: &str = "sshx-backend";
